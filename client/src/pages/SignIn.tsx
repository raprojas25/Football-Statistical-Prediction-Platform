              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      className="shadow-theme-xs focus:outline-hidden focus:ring-3 h-11 w-full appearance-none rounded-lg border px-4 py-2.5 text-sm placeholder:text-gray-400 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                    ...
                    >
                      {showPassword ? (
                        ...
                        <EyeClosedIcon className="size-5 fill-gray-500 dark:fill-gray-400" />
                      )}
                    </span>
                  </div>
                </div>
