...
function calculatePrediction(
  ...
  return {
    ...
    cf_over_25: calcOr(0, hCorners.for_over_2_5, aCorners.against_over_2_5),
    ...
    ca_over_25: calcOr(0, aCorners.for_over_2_5, hCorners.against_over_2_5),
