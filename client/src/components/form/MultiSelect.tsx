    ...
    <div className="w-full" ref={dropdownRef}>
      ...
      <div className="relative z-20 inline-block w-full">
        <div className="relative flex flex-col items-center">
          ...
          >
            <div
              className={`shadow-theme-xs outline-hidden focus:border-brand-300 focus:shadow-focus-ring dark:focus:border-brand-300 mb-2 flex min-h-11 rounded-lg border border-gray-300 py-1.5 pl-3 pr-3 transition dark:border-gray-700 dark:bg-gray-900 ${
                disabled
            ...
            >
              ...
              <div className="flex w-7 items-center self-start py-1 pl-1 pr-1">
                <button
                  ...
                  disabled={disabled}
                  className="outline-hidden focus:outline-hidden h-5 w-5 cursor-pointer text-gray-700 disabled:cursor-not-allowed dark:text-gray-400"
                >
                  <svg
