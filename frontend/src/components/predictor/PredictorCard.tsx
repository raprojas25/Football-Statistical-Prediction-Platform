...
export const PredictorCard = () => {
  ...
  return (
    <div
      key={1}
      className={`bg-betano-card flex flex-col justify-between overflow-hidden rounded-xl border shadow-md transition-all duration-300 hover:scale-[1.01] hover:shadow-lg ${true ? 'border-green-500/20 hover:border-green-500/40' : 'border-betano-border hover:border-betano-light'}`}
    >
      {/* Header */}
      ...
      <div className="flex flex-grow flex-col justify-between space-y-4 p-3">
        ...
        <div className="grid grid-cols-3 gap-1.5">
          <div
            className={`flex flex-col items-center justify-center rounded-lg border px-2 py-1 text-center transition-all ${actualWinner === 'HOME' ? 'border-green-500/40 bg-green-500/10 font-bold text-green-400' : 'border-betano-border/60 text-betano-muted bg-slate-900/30'}`}
          >
          ...
          <div
            className={`flex flex-col items-center justify-center rounded-lg border px-2 py-1 text-center transition-all ${actualWinner === 'DRAW' ? 'border-yellow-500/40 bg-yellow-500/10 font-bold text-yellow-400' : 'border-betano-border/60 text-betano-muted bg-slate-900/30'}`}
          >
          ...
          <div
            className={`flex flex-col items-center justify-center rounded-lg border px-2 py-1 text-center transition-all ${actualWinner === 'AWAY' ? 'border-blue-500/40 bg-blue-500/10 font-bold text-blue-400' : 'border-betano-border/60 text-betano-muted bg-slate-900/30'}`}
          >
        ...
        {/* Prediction */}
        <div className="border-betano-border/40 mt-4 space-y-2 rounded-lg border bg-slate-950/40 p-3 py-2">
          ...
          <div className="border-betano-border/50 flex items-center justify-between border-t pt-1">
