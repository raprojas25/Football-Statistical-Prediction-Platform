  ...
  return (
    <div className="container grid grid-cols-2">
      <div className="relative flex h-72 w-44 flex-col overflow-hidden rounded-sm bg-gradient-to-b from-red-950 to-black text-white shadow-lg shadow-slate-950/70">
        <div className="absolute top-6 -left-[15%] h-44 w-[150%] origin-left -rotate-12 transform bg-gradient-to-br from-orange-800/80 via-orange-900/60 to-orange-900/30"></div>
        <div className="relative z-20 px-3 pt-8">
          <div className="font-sans text-5xl tracking-tighter text-white italic">
            MAXON
          </div>
          <span className="mt-1 block font-sans text-[9px] font-bold tracking-[0.32em] text-gray-300 uppercase">
            General Use
          </span>
          <span className="mt-1 block text-[7px] font-light tracking-[0.2em] text-gray-400 uppercase italic">
      ...
      <div className="relative flex h-72 w-44 flex-col overflow-hidden rounded-sm bg-gradient-to-b from-violet-900 via-black to-violet-800/70 p-3 text-white shadow-lg shadow-slate-950/70">
        ...
        <div className="font-sans text-[9px] leading-5 tracking-widest text-orange-400 uppercase">
          High Grade
        </div>
        ...
        <div className="text-center text-[8px] tracking-[0.15rem] text-gray-400 uppercase">
          Clear · Crisp · Colour
        </div>
