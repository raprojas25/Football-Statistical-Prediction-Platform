            ...
            <form action="https://formbold.com/s/unique_form_id" method="POST">
              <div className="relative">
                ...
                <input
                  ...
                  className="shadow-xs focus:border-brand-300 outline-none focus:ring-[3px] focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pl-12 pr-14 text-sm text-gray-800 placeholder:text-gray-400 dark:border-gray-800 dark:bg-dark-900 dark:bg-gray-900 dark:bg-white/[0.03] dark:text-white/90 dark:placeholder:text-white/30 xl:w-[430px]"
                />
